...
def server():
    ...
    server_address = ('', 5000)                             #host vazio sinaliza que o servidor aceitra conexões de qualquer fonte interna, mas obrigatoriamente o computador precisa saber qual porta "escuta" as requisições, é equivalente a 0.0.0.0 para IPv4 e :: para IPv6, 127.0.0.1 e localhost aceitariam apenas conexões internas
